...
import { AuthorizationContextInterceptor } from '../../src/authorizations/authorization-context.interceptor.js';
...
function createInterceptor(
...
): { interceptor: AuthorizationContextInterceptor; updates: Array<Record<string, unknown>> } {
  ...
  return { interceptor: new AuthorizationContextInterceptor(repository, requestContext), updates };
}
...
test('uses the :tenantId route param as the authorization context and publishes trustedTenantId', async () => {
